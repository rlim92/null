...
dm1.messages.create(text: "Hi!", author_id: void.id)
dm2.messages.create(text: "Hey!", author_id: flame.id)
dm3.messages.create(text: "Hiya!", author_id: tidal.id)
dm4.messages.create(text: "Howdy!", author_id: shock.id)
dm5.messages.create(text: "Hello!", author_id: cloud.id)
team_dm.messages.create(text: "Greetings!", author_id: rich.id)
edm.messages.create(text: "Urg.", author_id: earth.id)